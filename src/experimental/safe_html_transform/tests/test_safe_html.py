...
class safe_htmlUnitTest(unittest.TestCase):
    ...
    def _getTargetClass(self):
        from experimental.safe_html_transform.safe_html import \
                                                            SafeHTML
        return SafeHTML
    ...
    def test_empty(self):
        ...
        self.assertEqual(self.transform.convert(orig, data), "")
    ...
    def test_keep_paragraphs(self):
        ...
        data = datastream(self.transform.name())
        self.assertEqual(self.transform.convert(html, data),
    ...
    def test_html_without_ptag(self):
        html = "<p>Keep me"
        data = datastream(self.transform.name())
        self.assertEqual(self.transform.convert(html, data), "<p>Keep me</p>")
